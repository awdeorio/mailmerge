...
Write a template email using [jinja2](http://jinja.pocoo.org/docs/latest/templates/) syntax and `mailmerge` will fill it in from a CSV file and, optionally, send it.
